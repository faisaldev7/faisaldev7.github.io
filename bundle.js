...
if (function() {
    ...
    function e() {
        if (!O && document.body) {
            ...
            var e = document.body
              ...
              , o = e.scrollHeight;
            if (k = document.compatMode.indexOf("CSS") >= 0 ? i : e,
            P = e,
            t(),
            top != self)
                Q = !0;
                ...
                s.setAttribute("id", "sscr"),
                s.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + k.scrollHeight + "px",
                document.body.appendChild(s);
                var r;
                S = function() {
                    r || (r = setTimeout(function() {
                        $ || (s.style.height = "0",
                        s.style.height = k.scrollHeight + "px",
                        r = null)
                    }, 500))
                }
                ,
            ...
            E.fixedBackground || $ || (e.style.backgroundAttachment = "scroll",
    ...
    function n(t, e, i) {
        ...
        1 != E.accelerationMax) {
            ...
            if (o < E.accelerationDelta) {
                var s = (1 + 50 / o) / 2;
                s > 1 && (s = Math.min(s, E.accelerationMax),
                e *= s,
                i *= s)
            }
            R = Date.now()
        ...
        !N) {
            var r = t === document.body
              , a = function(n) {
                ...
                r ? window.scrollBy(s, l) : (s && (t.scrollLeft += s),
                l && (t.scrollTop += l)),
                e || i || (M = []),
                M.length ? B(a, t, 1e3 / E.frameRate + 1) : N = !1
            };
            B(a, t, 0),
            N = !0
        }
    ...
    function o(t) {
        ...
        s || r || (r = -t.wheelDelta || 0),
        1 === t.deltaMode && (s *= 40,
        r *= 40),
        !E.touchpadSupport && y(r) ? !0 : (Math.abs(s) > 1.2 && (s *= E.stepSize / 120),
        Math.abs(r) > 1.2 && (r *= E.stepSize / 120),
        n(o, s, r),
        t.preventDefault(),
        void a())
    }
    function s(t) {
        ...
        switch (d == document.body && (p = window.innerHeight),
        t.keyCode) {
        case L.up:
            u = -E.arrowScroll;
            break;
        ...
        if (-1 != document.URL.indexOf("www.youtube.com/watch"))
            do
                if (i = e.classList && e.classList.contains("html5-video-controls"))
                    break;
            while (e = e.parentNode);return i
    }
    function T(t) {
        var e, i, n;
        return t *= E.pulseScale,
        1 > t ? e = t - (1 - Math.exp(-t)) : (i = Math.exp(-1),
        t -= 1,
        n = 1 - Math.exp(-t),
        e = i + n * (1 - i)),
        e * E.pulseNormalize
    ...
    var F, B = function() {
        ...
        return function() {
            if (!t) {
                ...
                window.scrollBy(0, 3),
                t = document.body.scrollTop != i ? document.body : document.documentElement,
                window.scrollBy(0, -3),
    ...
    c("load", e)),
    _.destroy = i,
    window.SmoothScrollOptions && _(window.SmoothScrollOptions),
...
function(t) {
    t.fn.downCount = function(e, i) {
        function n() {
            ...
            s.find(".days").text(p),
            s.find(".hours").text(c),
            s.find(".minutes").text(f),
            s.find(".seconds").text(m),
            s.find(".days_ref").text(g),
            s.find(".hours_ref").text(y),
            s.find(".minutes_ref").text(v),
        ...
        Date.parse(o.date) || t.error("Incorrect date format, it should look like this, 12/24/2012 12:00:00.");
        var s = this
          , r = function() {
            var t = new Date
    ...
    t.flexslider = function(e, i) {
        ...
        m = {
            init: function() {
                ...
                n.transitions = !n.vars.video && !c && n.vars.useCSS && function() {
                    ...
                    for (var i in e)
                        if (void 0 !== t.style[e[i]])
                            return n.pfx = e[i].replace("Perspective", "").toLowerCase(),
                ...
                n.vars.keyboard && (1 === t(n.containerSelector).length || n.vars.multipleKeyboard) && t(document).bind("keyup", function(t) {
                    var e = t.keyCode;
                ...
                (!c || c && n.vars.smoothHeight) && t(window).bind("resize orientationchange focus", m.resize),
                ...
                setupPaging: function() {
                    ...
                    n.pagingCount > 1)
                        for (var a = 0; a < n.pagingCount; a++) {
                            if (i = n.slides.eq(a),
                            e = "thumbnails" === n.vars.controlNav ? '<img src="' + i.attr("data-thumb") + '"/>' : "<a>" + r + "</a>",
            ...
            pausePlay: {
                setup: function() {
                    ...
                    n.pausePlay = t("." + s + "pauseplay a", n.controlsContainer)) : (n.append(e),
                    n.pausePlay = t("." + s + "pauseplay a", n)),
                    m.pausePlay.update(n.vars.slideshow ? s + "pause" : s + "play"),
                    n.pausePlay.bind(l, function(e) {
                        e.preventDefault(),
                        ("" === h || h === e.type) && (t(this).hasClass(s + "pause") ? (n.manualPause = !0,
                        n.manualPlay = !1,
            ...
            touch: function() {
                ...
                function i(t) {
                    ...
                    if (i) {
                        ...
                        return x += u ? o : n,
                        f = x,
                        w = u ? Math.abs(x) < Math.abs(-n) : Math.abs(x) < Math.abs(-o),
                        t.detail === t.MSGESTURE_FLAG_INERTIA ? void setImmediate(function() {
                            e._gesture.stop()
                        }) : void ((!w || Number(new Date) - m > 500) && (t.preventDefault(),
                        !c && i.transitions && (i.vars.animationLoop || (f = x / (0 === i.currentSlide && 0 > x || i.currentSlide === i.last && x > 0 ? Math.abs(x) / h + 2 : 1)),
                ...
                e.addEventListener("MSGestureEnd", o, !1)) : (g = function(t) {
                    ...
                    s = u ? T : b,
                    a = u ? b : T,
                    e.addEventListener("touchmove", y, !1),
                ...
                y = function(t) {
                    ...
                    T = t.touches[0].pageY,
                    f = u ? s - T : s - b,
                    w = u ? Math.abs(f) < Math.abs(b - a) : Math.abs(f) < Math.abs(T - a);
                    var e = 500;
                    (!w || Number(new Date) - m > e) && (t.preventDefault(),
                    !c && n.transitions && (n.vars.animationLoop || (f /= 0 === n.currentSlide && 0 > f || n.currentSlide === n.last && f > 0 ? Math.abs(f) / h + 2 : 1),
                    n.setProps(l + f, "setTouch")))
                }
                ,
                v = function(t) {
                    if (e.removeEventListener("touchmove", y, !1),
                    n.animatingTo === n.currentSlide && !w && null !== f) {
                        var i = d ? -f : f
            ...
            resize: function() {
                !n.animating && n.is(":visible") && (p || n.doMath(),
                c ? m.smoothHeight() : p ? (n.slides.width(n.computedW),
                n.update(n.pagingCount),
                n.setProps()) : u ? (n.viewport.height(n.h),
                n.setProps(n.h, "setTotal")) : (n.vars.smoothHeight && m.smoothHeight(),
            ...
            !n.animating && (n.canAdvance(e, l) || o) && n.is(":visible")) {
                if (f && r) {
                    ...
                    Math.ceil((e + 1) / n.visible) - 1 === n.currentSlide || 0 === e)
                        ...
                        n.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"),
                        !1;
                    n.currentItem = e,
                    n.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"),
                ...
                p || n.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"),
                n.atEnd = 0 === e || e === n.last,
                n.vars.directionNav && m.directionNav.update(),
                e === n.last && (n.vars.end(n),
                n.vars.animationLoop || n.pause()),
                c)
                    a ? (n.slides.eq(n.currentSlide).css({
                        opacity: 0,
                        zIndex: 1
                    }),
                    n.slides.eq(e).css({
                    ...
                    p ? (g = n.vars.itemMargin,
                    v = (n.itemW + g) * n.move * n.animatingTo,
                    y = v > n.limit && 1 !== n.visible ? n.limit : v) : y = 0 === n.currentSlide && e === n.count - 1 && n.vars.animationLoop && "next" !== n.direction ? d ? (n.count + n.cloneOffset) * w : 0 : n.currentSlide === n.last && 0 === e && n.vars.animationLoop && "prev" !== n.direction ? d ? 0 : (n.count + 1) * w : d ? (n.count - 1 - e + n.cloneOffset) * w : (e + n.cloneOffset) * w,
        ...
        n.setup = function(e) {
            if (c)
                ...
                n.cloneCount = 0,
                n.cloneOffset = 0,
                d && (o = t.makeArray(n.slides).reverse(),
                n.slides = t(o),
                n.container.empty().append(n.slides))),
                n.vars.animationLoop && !p && (n.cloneCount = 2,
                n.cloneOffset = 1,
                ...
                i = d ? n.count - 1 - n.currentSlide + n.cloneOffset : n.currentSlide + n.cloneOffset,
        ...
        n.update = function(t, e) {
            n.doMath(),
            p || (t < n.currentSlide ? n.currentSlide += 1 : t <= n.currentSlide && 0 !== t && (n.currentSlide -= 1),
            n.animatingTo = n.currentSlide),
            n.vars.controlNav && !n.manualControls && ("add" === e && !p || n.pagingCount > n.controlNav.length ? m.controlNav.update("add") : ("remove" === e && !p || n.pagingCount < n.controlNav.length) && (p && n.currentSlide > n.last && (n.currentSlide -= 1,
            n.animatingTo -= 1),
        ...
        n.addSlide = function(e, i) {
            ...
            n.count += 1,
            n.last = n.count - 1,
            u && d ? void 0 !== i ? n.slides.eq(n.count - i).after(o) : n.container.prepend(o) : void 0 !== i ? n.slides.eq(i).before(o) : n.container.append(o),
            n.update(i, "add"),
        ...
        n.removeSlide = function(e) {
            ...
            n.count -= 1,
            n.last = n.count - 1,
            isNaN(e) ? t(e, n.slides).remove() : u && d ? n.slides.eq(n.last).remove() : n.slides.eq(e).remove(),
            n.doMath(),
            n.update(i, "remove"),
            n.slides = t(n.vars.selector + ":not(.clone)", n),
            n.setup(),
    ...
    function s(e) {
        ...
        function s(t) {
            ...
            t && "object" == typeof t && t.nodeType) {
                ...
                var C = i(e.height);
                return C !== !1 && (s.height = C + (_ ? 0 : v + x)),
                s.innerWidth = s.width - (y + T),
                s.innerHeight = s.height - (v + x),
                s.outerWidth = s.width + w,
        ...
        function l(e, i) {
            ...
            var n = e.style
              ...
              , s = e.runtimeStyle
              , r = s && s.left;
            return r && (s.left = e.currentStyle.left),
            n.left = i,
            i = n.pixelLeft,
            n.left = o,
            r && (s.left = r),
...
function(t, e) {
    ...
    n.prototype._getItemLayoutPosition = function(t) {
        ...
        for (var s = this._getColGroup(o), r = Math.min.apply(Math, s), a = i.indexOf(s, r), l = {
            ...
            y: r
        }, h = r + t.size.outerHeight, u = this.cols + 1 - s.length, d = 0; u > d; d++)
            this.colYs[a + d] = h;
        return l
    }
    ,
...
function(t) {
    t.fn.appear = function(e, i) {
        ...
        return this.each(function() {
            ...
            n.one ? i.one("appear", n.data, r) : i.bind("appear", n.data, r),
            o.scroll(s),
...
function(jQuery, ytp) {
    if (ytp.isDevice = "ontouchstart"in window,
    !jQuery.browser) {
        jQuery.browser = {},
        ...
        return this.each(function() {
            ...
            if (0 !== s.length && t) {
                ...
                if (jQuery.support.transition) {
                    var a = ""
                      , l = "transitionEnd";
                    jQuery.browser.webkit ? (a = "-webkit-",
                    l = "webkitTransitionEnd") : jQuery.browser.mozilla ? (a = "-moz-",
                    l = "transitionend") : jQuery.browser.opera ? (a = "-o-",
                    l = "otransitionend") : jQuery.browser.msie && (a = "-ms-",
                    l = "msTransitionEnd"),
                    r = [];
                    for (u in t) {
                        var h = u;
                        "transform" === h && (h = a + "transform",
                        t[h] = t[u],
                        delete t[u]),
                        "transform-origin" === h && (h = a + "transform-origin",
                        t[h] = t[u],
                        delete t[u]),
                        r.push(h),
                        s.css(h) || s.css(h, 0)
                    ...
                    u = r.join(","),
                    s.css(a + "transition-property", u),
                    s.css(a + "transition-duration", e + "ms"),
                    s.css(a + "transition-delay", i + "ms"),
                    s.css(a + "transition-timing-function", n),
                    s.css(a + "backface-visibility", "hidden"),
                    setTimeout(function() {
                        s.css(t)
                    }, 0),
                    setTimeout(function() {
                    ...
                    s.on(l, function(t) {
                        ...
                        s.css(a + "transition", ""),
                        t.stopPropagation(),
                        "function" == typeof o && (s.called = !0,
                        o()),
                        !1
                    })
                } else {
                    for (var u in t)
                        "transform" === u && delete t[u],
                        "transform-origin" === u && delete t[u],
                        "auto" === t[u] && delete t[u];
                    o && "string" != typeof o || (o = "linear"),
                    s.animate(t, e, o)
                }
            }
        })
    ...
    jQuery.fn.CSSAnimateStop = function() {
        var t = ""
          , e = "transitionEnd";
        jQuery.browser.webkit ? (t = "-webkit-",
        e = "webkitTransitionEnd") : jQuery.browser.mozilla ? (t = "-moz-",
        e = "transitionend") : jQuery.browser.opera ? (t = "-o-",
        e = "otransitionend") : jQuery.browser.msie && (t = "-ms-",
        e = "msTransitionEnd"),
    ...
    jQuery.mbYTPlayer = {
        ...
        buildPlayer: function(options) {
            return this.each(function() {
                ...
                jQuery.metadata && (jQuery.metadata.setType("class"),
                property = $YTPlayer.metadata()),
                jQuery.isEmptyObject(property) && (property = $YTPlayer.data("property") && "string" == typeof $YTPlayer.data("property") ? eval("(" + $YTPlayer.data("property") + ")") : $YTPlayer.data("property")),
                ...
                !YTPlayer.isBackground || !ytp.isInit) {
                    ...
                    $YTPlayer.hide(),
                    YTPlayer.opt.containment.prepend(wrapper)) : YTPlayer.opt.containment.prepend(wrapper),
                            ...
                            return ytp.isDevice && !YTPlayer.isBackground ? void new YT.Player(playerID,{
                                ...
                                events: {
                                    onReady: function(t) {
                                        ...
                                        YTPlayer.isReady || (YTPlayer.isReady = !0,
                                    ...
                                    onStateChange: function(t) {
                                        if ("function" == typeof t.target.getPlayerState) {
                                            ...
                                            var i = (jQuery(YTPlayer.playerEl),
                                            ...
                                            if (0 == e) {
                                                ...
                                                $YTPlayer.playYTP(),
                                                YTPlayer.player.seekTo(o, !0)) : YTPlayer.isBackground || (YTPlayer.player.seekTo(o, !0),
                                                $YTPlayer.playYTP(),
                                                setTimeout(function() {
                                                    $YTPlayer.pauseYTP()
                                                }, 10)),
                                                !n.loop && YTPlayer.isBackground ? YTPlayer.wrapper.CSSAnimate({
                                                    opacity: 0
                                                }, 2e3) : n.loop && (YTPlayer.wrapper.css({
                                                    opacity: 0
                                                }),
                                                YTPlayer.loop++),
                                                i.find(".mb_YTVPPlaypause").html(jQuery.mbYTPlayer.controls.play),
                                            ...
                                            if (1 == e) {
                                                ...
                                                YTPlayer.state = e,
                                                YTPlayer.player.setPlaybackQuality(YTPlayer.opt.quality),
                                                YTPlayer.opt.mute && ($YTPlayer.muteYTPVolume(),
                                                YTPlayer.opt.mute = !1),
                                                YTPlayer.opt.autoPlay && 0 == YTPlayer.loop ? YTPlayer.wrapper.CSSAnimate({
                                                ...
                                                i.find(".mb_YTVPPlaypause").html(jQuery.mbYTPlayer.controls.pause),
        ...
        getDataFromFeed: function(t, e) {
            e.videoID = t,
            jQuery.browser.msie ? ("auto" == e.opt.ratio ? e.opt.ratio = "16/9" : e.opt.ratio,
            e.isInit || (e.isInit = !0,
            setTimeout(function() {
                jQuery(document).trigger("getVideoInfo_" + e.opt.id)
            }, 100)),
            jQuery(e).trigger("YTPChanged")) : (jQuery.getJSON(jQuery.mbYTPlayer.locationProtocol + "//gdata.youtube.com/feeds/api/videos/" + t + "?v=2&alt=jsonc", function(t, i, n) {
                e.dataReceived = !0;
                var o = t.data;
                if (e.title = o.title,
                e.videoData = o,
                "auto" == e.opt.ratio && (o.aspectRatio && "widescreen" === o.aspectRatio ? e.opt.ratio = "16/9" : e.opt.ratio = "4/3"),
                !e.isInit) {
                    if (e.isInit = !0,
                    !e.isBackground) {
            ...
            setTimeout(function() {
                e.dataReceived || e.isInit || (e.isInit = !0,
                jQuery(document).trigger("getVideoInfo_" + e.opt.id))
            }, 2500))
        },
        getVideoID: function() {
        ...
        fullscreen: function(t) {
            function e(t, e) {
                for (var i, n, o = ["webkit", "moz", "ms", "o", ""], s = 0; s < o.length && !t[i]; ) {
                    if (i = e,
                    "" == o[s] && (i = i.substr(0, 1).toLowerCase() + i.substr(1)),
                    i = o[s] + i,
                    n = typeof t[i],
                    "undefined" != n)
                        return o = [o[s]],
            ...
            if (t) {
                ...
                jQuery(document).on(l, function() {
                    ...
                    o.isBackground ? jQuery("body").after(s) : o.wrapper.before(s),
            ...
            r.html(jQuery.mbYTPlayer.controls.onlyYT),
            o.isAlone = !1) : (1 != o.player.getPlayerState() && 2 != o.player.getPlayerState() && jQuery(o).playYTP(),
            t ? (o.wrapper.append(s),
        ...
        stopYTP: function() {
            var t = this.get(0)
              , e = jQuery("#controlBar_" + t.id)
              , i = e.find(".mb_YTVPPlaypause");
            i.html(jQuery.mbYTPlayer.controls.play),
            t.player.stopVideo()
        },
        pauseYTP: function() {
            var t = this.get(0)
            ...
            if (!jQuery("#controlBar_" + t.id).length) {
                ...
                var l = jQuery("<span/>").html(jQuery.mbYTPlayer.controls.ytLogo).addClass("mb_YTVPUrl ytpicon").attr("title", "view on YouTube").on("click", function() {
                  ...
                  , u = jQuery("<div/>").addClass("mb_YTVPProgress").css("position", "absolute").click(function(e) {
                    ...
                    t.timeW = e.clientX - p.offset().left,
                    i.find(".mb_YTVPLoaded").css({
                        width: 0
                    });
                    var n = Math.floor(t.player.getDuration());
                    t["goto"] = p.outerWidth() * n / u.outerWidth(),
                ...
                u.append(d).append(p),
                n.append(o).append(s).append(r),
                e.printUrl && n.append(l),
                (t.isBackground || t.opt.realfullscreen && !t.isBackground) && n.append(h),
                i.append(n).append(u),
                t.isBackground ? jQuery("body").after(i) : (i.addClass("inlinePlayer"),
                t.wrapper.before(i)),
                i.fadeIn()
            }
        },
    ...
    jQuery.fn.toggleVolume = function() {
        var t = this.get(0);
        if (t)
            return t.player.isMuted() ? (jQuery(t).unmuteYTPVolume(),
            !0) : (jQuery(t).muteYTPVolume(),
            !1)
    }
    ,
    jQuery.fn.optimizeDisplay = function() {
        ...
        var s = 24
          , r = {};
        r.width = n.width + n.width * s / 100,
        r.height = "16/9" == e.ratio ? Math.ceil(9 * n.width / 16) : Math.ceil(3 * n.width / 4),
        r.marginTop = -((r.height - n.height) / 2),
        r.marginLeft = -(n.width * (s / 2) / 100),
        r.height < n.height && (r.height = n.height + n.height * s / 100,
        r.width = "16/9" == e.ratio ? Math.floor(16 * n.height / 9) : Math.floor(4 * n.height / 3),
        r.marginTop = -(n.height * (s / 2) / 100),
...
!function(t, e) {
    ...
    function n(n, r) {
        function a() {
            if (P) {
                y = e.createElement("canvas"),
                y.className = "pg-canvas",
                y.style.display = "block",
                n.insertBefore(y, n.firstChild),
                v = y.getContext("2d"),
                l();
                ...
                I && !Y && t.addEventListener("deviceorientation", function() {
                    $ = Math.min(Math.max(-event.beta, -30), 30),
        ...
        function l() {
            y.width = n.offsetWidth,
            y.height = n.offsetHeight,
            v.fillStyle = r.dotColor,
            v.strokeStyle = r.lineColor,
        ...
        function c() {
            ...
            case "right":
                ...
                break;
            default:
                this.speed.x = +(-r.maxSpeedX / 2 + Math.random() * r.maxSpeedX).toFixed(2),
                this.speed.x += this.speed.x > 0 ? r.minSpeedX : -r.minSpeedX
            }
            switch (r.directionY) {
            case "up":
            ...
            case "down":
                ...
                break;
            default:
                this.speed.y = +(-r.maxSpeedY / 2 + Math.random() * r.maxSpeedY).toFixed(2),
                this.speed.x += this.speed.y > 0 ? r.minSpeedY : -r.minSpeedY
            }
        }
        function f(t, e) {
        ...
        return r = i({}, t[o].defaults, r),
        c.prototype.draw = function() {
            v.beginPath(),
            v.arc(this.position.x + this.parallaxOffsetX, this.position.y + this.parallaxOffsetY, r.particleRadius / 2, 0, 2 * Math.PI, !0),
            v.closePath(),
            v.fill(),
            v.beginPath();
        ...
        c.prototype.updatePosition = function() {
            if (r.parallax) {
                if (I && !Y) {
                    ...
                    x = S,
                    _ = j;
                this.parallaxTargX = (x - b / 2) / (r.parallaxMultiplier * this.layer),
                this.parallaxOffsetX += (this.parallaxTargX - this.parallaxOffsetX) / 10,
                this.parallaxTargY = (_ - T / 2) / (r.parallaxMultiplier * this.layer),
...
!function(t, e, i, n) {
    ...
    o.Pipe = [{
        ...
        run: function() {
            ...
            e = Math.abs(o / 2); e > t; t++)
                o > 0 ? (this.$stage.children().eq(n.length + i.length - 1).remove(),
                i.pop(),
    ...
    o.prototype.setup = function() {
        ...
        }).addClass("owl-responsive-" + n)) : o = t.extend({}, this.options),
    ...
    o.prototype.onDragStart = function(n) {
        var o, r, a, l;
        if (o = n.originalEvent || n || e.event,
    ...
    o.prototype.onDragEnd = function(e) {
        ...
        if (this.state.isTouch) {
            ...
            (o > 3 || n > 300) && this.removeClick(this.drag.targetEl),
    ...
    o.prototype.maximum = function(t) {
        ...
        if (!s.loop && s.center)
            ...
            if (s.loop || s.center)
                ...
                for (revert = s.rtl ? 1 : -1,
                i = this.$stage.width() - this.$element.width(); (n = this.coordinates(o)) && !(n * revert >= i); )
                    e = ++o
            }
        else
            e = this._items.length - s.items;
    ...
    o.prototype.to = function(i, n) {
        if (this.settings.loop) {
            ...
            a < this.settings.items && l === !1 ? (s = r + this._items.length,
            this.reset(s)) : a >= h - this.settings.items && l === !0 && (s = r - this._items.length,
            this.reset(s)),
...
function(t, e, i) {
    ...
    n.prototype.thumbnail = function(e, i) {
        ...
        a.length ? (d(a.attr(l)),
        a.remove(),
        !1) : void ("youtube" === i.type ? (s = "http://img.youtube.com/vi/" + i.id + "/hqdefault.jpg",
...
function(t) {
    ...
    e.prototype.draw = function() {
        var e, i, n = "", o = this._core.settings, s = (this._core.$stage.children(),
    ...
    e.prototype.to = function(e, i, n) {
        var o;
        n ? t.proxy(this._overrides.to, this._core)(e, i) : (o = this._pages.length,
...
!function(t, e, i, n) {
    function o(e, i) {
        ...
        this.positionX != n && (r[0] = this.positionX.toLowerCase()),
        this.positionY != n && (r[1] = this.positionY.toLowerCase()),
        s.positionX = r[0],
        s.positionY = r[1],
    ...
    function s(n) {
        return this.each(function() {
            ...
            s.data("px.parallax", new o(this,r))),
            "string" == typeof n && o[n]()
        })
    }
    !function() {
        ...
        setup: function() {
            if (!this.isReady) {
                ...
                s.on("resize.px.parallax load.px.parallax", function() {
                    ...
                    o.overScroll = Math.max(s.scrollTop() - t, Math.min(s.scrollTop(), 0)),
                    o.requestRender()
                }),
                this.isReady = !0
            }
